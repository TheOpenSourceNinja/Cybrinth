...
class SettingsScreen : public irr::IEventReceiver {
	...
	private:
		...
		irr::gui::IGUIEditBox* dateFormatEditBox;
		irr::gui::IGUIStaticText* dateFormatText;
		...
		irr::gui::IGUIEditBox* timeFormatEditBox;
		irr::gui::IGUIStaticText* timeFormatText;
